...
def generate(owner, repo, email_domain_list):
    ...
    from (select id, b.company
          from (select * from github_issues where search_key__owner = '{owner}' and search_key__repo = '{repo}' and 
          pull_request__url = '') as a global
...
ID = 'COMPANY_ISSUES_IN_PROJECT'
TEMPLATE_INFO = {
    "label": "各公司在项目中发起的Issue",
    "template_id": ID,
    "params": [
        {
