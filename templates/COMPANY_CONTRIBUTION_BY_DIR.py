...
def generate(owner, repo, email_domain_list, dir_level):
    arg1 = ""
    arg2 = ""
    arg3 = ""
    ...
    return f"""select search_key__owner, search_key__repo, in_dir, company, count() as company_alter_file_count
...
######################################
ID = 'COMPANY_CONTRIBUTION_BY_DIR'
TEMPLATE_INFO = {
    "label": "公司在项目中的贡献（按目录层级划分）",
    "template_id": ID,
    "params": [
        {
